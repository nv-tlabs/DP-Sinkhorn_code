...
#
# This file has been modified from a file in the TTUR library
...
''' Used by finalize_result.py to get FID scores (with tensorflow)
...
def calculate_frechet_distance(mu1, sigma1, mu2, sigma2, eps=1e-6):
    ...
    part1 = diff.dot(diff)
    part2 = np.trace(sigma1) + np.trace(sigma2) - 2 * tr_covmean
    print(part1, part2, np.trace(sigma1), np.trace(sigma2))
    return part1 + part2
#-------------------------------------------------------------------------------


def calculate_activation_statistics(images, sess, batch_size=20, verbose=False):
